...
load(file = "ICP_all_clean/ICP_all.RData")  

load(file = "ICP_all_clean/ICP_data_all.RData")


dir.create('ICP_all_processed')
...
save(ID_Number, file = "ICP_all_processed/ID_Number.RData")


load(file = "ICP_all_processed/ID_Number.RData")
...
save(ICP_targets , file = paste0("ICP_all_processed/ICP_targets.RData"))
...
load(file = "ICP_all_processed/ICP_all.RData")  
...
save(ICP_all, file = paste0("ICP_all_processed/ICP_all_", Faktor,".RData"))
...
load(ICP_all, file = paste0("ICP_all_processed/ICP_all_", Faktor,".RData"))
...
save(ICP_all, file = paste0("ICP_all_processed/ICP_all_", Faktor,"outlier.RData"))


load(file = paste0("ICP_all_processed/ICP_all_", Faktor,"outlier.RData"))
...
save(ICP_all_wide, file = "ICP_all_processed/ICP_all_wide_5min.RData")
...
load(file = "ICP_all_processed/ICP_all_wide_5min.RData")  

load(file = "ICP_all_processed/ICP_data_all_target.RData")
...
save(ICP_pred, file = "ICP_all_processed/ICP_pred_list.RData")

save(ICP_crit_list, file = "ICP_all_processed/ICP_crit_list.RData")
...
load(file = paste0("ICP_all_processed/ICP_all_", Faktor,".RData"))
...
save(ICP_all_znorm, file = paste0("ICP_all_processed/ICP_all_znorm_",Faktor,"min.RData"))
...
save(ICP_all_minmax, file = paste0( "ICP_all_processed/ICP_all_minmax_",Faktor,"min.RData"))
...
save(ICP_all_yeojo, file = paste0( "ICP_all_processed/ICP_all_yeojo_",Faktor,"min.RData"))


# loading

load(file = paste0("ICP_all_processed/ICP_targets.RData"))
...
load(file = paste0( "ICP_all_processed/ICP_all_znorm_",Faktor,"min.RData"))
...
load( file = "ICP_all_processed/ICP_pred_6h.RData")
load( file = "ICP_all_processed/ICP_pred_3h.RData")
load( file = "ICP_all_processed/ICP_pred_1h.RData")
...
save(ICP_znorm_wide_6h, 
     file = paste0("ICP_all_processed/ICP_all_znorm_wide_",Faktor,"min_6h.RData"))
save(ICP_znorm_wide_3h, 
     file = paste0("ICP_all_processed/ICP_all_znorm_wide_",Faktor,"min_3h.RData"))
save(ICP_znorm_wide_1h, 
     file = paste0("ICP_all_processed/ICP_all_znorm_wide_",Faktor,"min_1h.RData"))


write.csv(ICP_znorm_wide_6h, 
          file = paste0("ICP_all_CSV/Datenbank_znorm_",Faktor,"min_6h.csv"), 
          row.names=FALSE, na="")
write.csv(ICP_znorm_wide_3h, 
          file = paste0("ICP_all_CSV/Datenbank_znorm_",Faktor,"min_3h.csv"), 
          row.names=FALSE, na="")
write.csv(ICP_znorm_wide_1h, 
          file = paste0("ICP_all_CSV/Datenbank_znorm_",Faktor,"min_1h.csv"), 
          row.names=FALSE, na="")
...
load(file = paste0( "ICP_all_processed/ICP_all_yeojo_",Faktor,"min.RData"))
...
load( file = "ICP_all_processed/ICP_pred_list.RData")
...
for (i in x) {
  ...
  save(ICP_yeojo_wide_final, 
       file = paste0("ICP_all_processed/ICP_all_yeojo_wide_",Faktor,"min_",i,"h.RData"))
}
...
for (i in x) {
  ...
  write.csv(ICP_yeojo_wide_final, 
            file = paste0("ICP_all_CSV/Datenbank_yeojo_",Faktor,"min_",i,"h.csv"), 
            row.names=FALSE, na="")
}
...
load(file = "ICP_all_processed/ICP_all_yeojo_wide_60min_1h.RData")
...
load(file = paste0( "ICP_all_processed/ICP_all_minmax_",Faktor,"min.RData"))
...
save(ICP_minmax_wide_6h, 
     file = paste0("ICP_all_processed/ICP_all_minmax_wide_",Faktor,"min_6h.RData"))
save(ICP_minmax_wide_3h, 
     file = paste0("ICP_all_processed/ICP_all_minmax_wide_",Faktor,"min_3h.RData"))
save(ICP_minmax_wide_1h, 
     file = paste0("ICP_all_processed/ICP_all_minmax_wide_",Faktor,"min_1h.RData"))


write.csv(ICP_minmax_wide_6h, 
          file = paste0("ICP_all_CSV/Datenbank_minmax_",Faktor,"min_6h.csv"), 
          row.names=FALSE, na="")
write.csv(ICP_minmax_wide_3h, 
          file = paste0("ICP_all_CSV/Datenbank_minmax_",Faktor,"min_3h.csv"), 
          row.names=FALSE, na="")
write.csv(ICP_minmax_wide_1h, 
          file = paste0("ICP_all_CSV/Datenbank_minmax_",Faktor,"min_1h.csv"), 
          row.names=FALSE, na="")
